...
let FormBackground = fromCss('form',
  ...
  FormDiv = fromCss('div', ({ hidden }) => 'padding:8px;' +
    `display:${hidden ? 'none' : 'block'};`, ['hidden']), FormHeader = fromCss('h2',
    'text-align:center;font-family:sans-serif;'), FormSubmit = fromCss('input',
    'font-family:sans-serif;text-transform:uppercase;margin:8px;border-radius:8px;font-size:16px;'),
  FormErrorMessage = fromCss('p',
