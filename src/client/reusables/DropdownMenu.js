...
let ContainerDiv = fromCss('div', 'width:10%;margin:0;text-align:center;' +
    'vertical-align:top;display:inline-block;overflow-y:scroll;height:100vh;'),
  TopLevelList = fromCss('ul', 'list-style-type:none;text-transform:uppercase;'
  + 'padding-left:0;font-family:sans-serif;display:block;' +
  'background-color:cadetblue;'), ListItem = fromCss('li', 'padding:8px;'),
  SubList = fromCss('ul', 'list-style-type:none;text-transform:uppercase;' +
    'padding-left:0;font-family:sans-serif;'), SubListItem = fromCss('li',
    'padding:8px 8px 0 8px;'), HoverLink = fromCss('a',
